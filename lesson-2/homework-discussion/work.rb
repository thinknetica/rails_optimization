...
def read_lines(file_lines, users, sessions, users_sessions)
  users = []
  sessions = []
  users_sessions = {}
  ...
  return users, sessions, users_sessions
end

def collect_unique_browsers(sessions)
  uniqueBrowsers = []
...
def work(filename, disable_gc: false)
  ...
  users, sessions, users_sessions =
    read_lines(file_lines, users, sessions, users_sessions)
  ...
  uniqueBrowsers = collect_unique_browsers(sessions)
